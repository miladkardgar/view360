...
$info = request()->getSchemeAndHttpHost();
$host_names = explode(".", $info);
$host_http = explode("//", $host_names[0]);
if(isset($host_names[2])){
$bottom_host_name = $host_http[0]."//".$host_names[1].".".$host_names[2];
}else{
$bottom_host_name = $info;
}
@endphp
<header id="ts-header" class="fixed-top rtl">
    ...
    <nav id="ts-primary-navigation" class="navbar navbar-expand-md navbar-left rtl">
        <div class="container rtl mr-0 ml-0">
            <!--Brand Logo-->
            <a class="navbar-brand " href="{{$bottom_host_name}}">
                <img src="{{url('/public/assets/img/logo.png')}}" width="140" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarPrimary">
                ...
                <ul class="navbar-nav rtl">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{$bottom_host_name}}">صفحه اصلی</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{$bottom_host_name}}/about">درباره ما</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mr-2" href="{{$bottom_host_name}}/contact">تماس با ما</a>
                    </li>
                </ul>
