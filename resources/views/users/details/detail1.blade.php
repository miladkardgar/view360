                            ...
                            <div class="owl-carousel ts-gallery-carousel" data-owl-auto-height="1" data-owl-dots="1"
                                ...
                                <div class="slide">
                                    <div class="ts-image" data-bg-image="{{url('/public/assets/img/img-detail-03.jpg')}}">
                                        <a href="assets/img/img-detail-05.jpg" class="ts-zoom popup-image"><i
                                                    class="fa fa-search-plus"></i>Zoom</a>
                                    </div>
                                </div>
                                        ...
                                        <form id="form-agent" class="ts-form">
                                            ...
                                            <div class="form-group">
                                                <textarea class="form-control" id="form-contact-message" rows="3"
                                                          name="message"
                                                          placeholder="سلام در مورد شماره فایل {{$id}}  اطلاعات بیشتری نیاز دارم."></textarea>
                                            </div>
                    ...
                    <div class="offset-lg-4 col-sm-12 col-lg-8">
                        ...
                        <div class="card ts-item ts-item__list ts-card">
                            ...
                            <a href="detail-01.html" class="card-img ts-item__image"
                               data-bg-image="a{{url('/public/assets/img/img-item-thumb-02.jpg')}}"></a>
