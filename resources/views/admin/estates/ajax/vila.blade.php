            ...
            <div class="col-12">
                <select name="countFloor" id="countFloor" required class="form-control">
                    ...
                    @foreach($floorsCount as $floorCount)
                        <option value="{{$floorCount->id}}">{{$floorCount->title}}</option>
                    @endforeach
                </select>
            </div>
        </div>
            ...
            @foreach($possibilitiesVila as $possibilities)
                <div class="col-12 col-md-3">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="possibilities_{{$possibilities->id}}"
                               value="{{$possibilities->id}}" name="possibilities_{{$possibilities->id}}">
