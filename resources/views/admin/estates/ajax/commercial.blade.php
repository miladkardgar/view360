...
<div class="row">
            ...
            <div class="col-12">
                <select name="transaction_type" id="transaction_type" class="form-control" required="required">
                    ...
                    @foreach($transactionTypesCommercial as $transactionTypeCommercial)
                        <option value="{{$transactionTypeCommercial->id}}">{{$transactionTypeCommercial->title}}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="col-12 col-md-3">
        <div class="form-group">
            ...
            <div class="col-12">
                <select name="commercialType" id="commercialType" class="form-control" required="required">
                    <option value="">انتخاب نمایید.</option>
                    @foreach($commercialTypes as $commercialType)
                        <option value="{{$commercialType->id}}">{{$commercialType->title}}</option>
                    @endforeach
                </select>
            </div>
        </div>
