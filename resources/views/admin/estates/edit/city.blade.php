                ...
                <div class="row mt-2">
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <select name="city_type_id" id="city_type_id" class="form-control" required="required">
                                    <option value="" class="disabled">انتخاب نمایید.</option>
                                    @foreach($cityType as $type)
                                        <option value="{{$type->id}}"
                                            {{$type->id === $req->city_type_id ? 'selected':''}}>{{$type->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
