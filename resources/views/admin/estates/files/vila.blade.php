        ...
        <div class="card-body text-black-50">
            <form action="/admin/estate/add" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                                ...
                                <select name="transaction_type" id="transaction_type" required class="form-control">
                                    ...
                                    @foreach($transActionTypesVila as $transAction)
                                        <option value="{{$transAction->id}}"
                                            {{$transAction->id === Request::old('transaction_type'?'selected':'')}}>{{$transAction->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            <label for="countFloor">تعداد طبقات</label>
                            <div class="col-12">
                                <select name="countFloor" id="countFloor" required class="form-control">
                                    <option value="">انتخاب نمایید.</option>
                                    @foreach($floorsCount as $floorCount)
                                        <option value="{{$floorCount->id}}"
                                            {{$floorCount->id === Request::old('countFloor')?'selected':''}}>{{$floorCount->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-12">
                        <label>امکانات</label>
                        <div class="row">
                            @foreach($possibilitiesVila as $possibilities)
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input"
                                                   id="possibilities_{{$possibilities->id}}"
                                                   value="{{$possibilities->id}}"
                                                   name="possibilities_{{$possibilities->id}}"
                                            {{$possibilities->id === Request::old('possibilities_'.$possibilities->id)?'checked':''}}>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="lon" id="lon" value="{{Request::old('lon')}}">
                        </div>
                    </div>
                    <div class="col-12 col-md-12">
