            ...
            $("#usersTable").DataTable({
                initComplete: function () {
                    this.api().columns().every(function () {
                        var column = this;
                        if (column[0] == 2 || column[0] == 3 || column[0] == 4 ||column[0] == 5 || column[0] == 6 || column[0] == 7 || column[0] == 9) {
            ...
            <table class="table" id="usersTable">
                ...
                @foreach($filesList as $fileList)
                    ...
                    <tr>
                        ...
                        <td>{{$fileList->area}}</td>
                        <td>{{$fileList->bedroom}}</td>
                        <td>{{$fileList->getCity->name}}</td>
                        ...
                        <td>
                            <div class="btn-group">
                            <a class="btn btn-xs btn-outline-{{$color}} btn_ChangeStatus"
                            ...
                            <a href="/admin/estate/edit/{{$fileList->data_id}}/{{$fileList->id}}/"
                               class="btn btn-xs btn-outline-dark btn_ChangeRole"><i
                                ...
                                <a href="/{{$fileList->data_id}}/{{$fileList->id}}"
                                   class="btn btn-xs btn-outline-dark " target="_blank"><i
                                        class="icon-eye"></i></a>
                            </div>
                        </td>
                    </tr>
